  ...
  return (
    <div>
      <div className="w-full flex lg:flex-row flex-col lg:h-screen ">
        <div className='lg:w-[50%] w-[100%] lg:h-full h-[55vh] lg:bg-cover bg-cover bg-no-repeat bg-[url("https://images.squarespace-cdn.com/content/v1/62cf04e8b198a72b456a17d6/1675276268687-BMMXEK3UUD77OFO7OR52/image.jpg?format=1500w")]'></div>
        <div className="lg:w-[45%] w-[95%] h-full flex flex-col gap-5 ">
          <div className=" text-black lg:mt-[15%] lg:text-[50px] text-[30px] font-bold lg:leading-[50px] leading-[35px] ml-[2.5%] ">
            Laser Hair Removal <br /> Technician License
          </div>
          ...
          <div className=" text-black text-[14px] ml-[2.5%] ">
            <span className="font-bold text-[#F9728C]">
              Course Highlights:    </span> <br />+ 2-Day Program: 8:30 am-6 pm. Must be
              taken consecutively on either a Monday + Tuesday, Wednesday +
